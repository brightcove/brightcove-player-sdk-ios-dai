# DAI Plugin for Brightcove Player SDK for iOS, version 7.2.3.11

## Installation

DAI Plugin for Brightcove Player SDK provides a dynamic library framework for installation.

The DAI plugin supports version 3.26.1 of the Google IMA SDK for iOS and version 4.15.1 of the Google IMA SDK for tvOS.
